...
export const LastTransationsCard = ({ transation, index }: TransationsCardType) => {
	useEffect(() => {

  });
	return (
		<>
      {transation.type === 'Receita' ? <TrendingUpIcon sx={{color: 'green'}}/> : <TrendingDownIcon sx={{color: 'red'}}/>}
